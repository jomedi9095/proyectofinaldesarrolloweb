...
if (isset($_SESSION["efectivoPrueba"])) {$efectivoPrueba = $_SESSION["efectivoPrueba"]; } 
...
<div class="todo">
	...
	<?php
		...
		echo "Efectivo:  ".number_format($efectivoPrueba,0,',','.');
        echo "<br>";

        
        
		echo "Cambio:  ".number_format($efectivoPrueba-$total,0,',','.');
